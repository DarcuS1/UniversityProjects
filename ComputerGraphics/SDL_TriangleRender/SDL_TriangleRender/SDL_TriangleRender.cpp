...
{
	egc::rasterizeTriangle(renderer, triangle, {
		egc::vec4(255.0, 0.0, 0.0, 255.0),
		egc::vec4(0.0, 255.0, 0.0, 255.0),
		egc::vec4(0.0, 0.0, 255.0, 255.0)
		});
}
...
int main(int argc, char * argv[]) {
	...
	while (!quit) {
		...
		if (SDL_WaitEvent(&currentEvent) != 0)
		{
			...
			drawWireframeTriangle(windowRenderer, triangle);
